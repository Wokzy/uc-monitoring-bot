...
from models.uc_api.base_models import GeneralResponseType, UserCreateResponse


class McpttUserCreateResponse(BaseModel):
    ...
    payload: UserCreateResponse = Field(description='Тело ответа')
