...
from models.uc_api.base_models import UCUsersList, GeneralResponseType


class UCUsersListResponse(BaseModel):
    ...
    payload: UCUsersList = Field(description='Тело ответа')
