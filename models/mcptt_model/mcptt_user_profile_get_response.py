...
from models.uc_api.base_models import UserProfileType, GeneralResponseType


class MCPTTUserProfileGetResponse(BaseModel):
    ...
    payload: UserProfileType = Field(description='Тело ответа')
