...
from models.uc_api.base_models import GroupProfile, GeneralResponseType


class MCPTTGroupProfileGetResponse(BaseModel):
    ...
    payload: GroupProfile = Field(description='Тело ответа')
