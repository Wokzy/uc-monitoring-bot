...
from models.uc_api.base_models import GeneralResponseType, DeleteMcpttGroupResponse1


class DeleteMcpttGroupResponse(BaseModel):
    ...
    payload: DeleteMcpttGroupResponse1 = Field(description='Тело ответа')
